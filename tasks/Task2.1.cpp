...
int main() {
    ...
    std::ofstream fout("py_graphics/task2.1.py");
    ...
    int value[] = {100,228,400,1337,1600,3200,5000,7000,10000,15000,20000,
                   ...
                   195000,225000,250000,295000,335000,375000,420000,465000,499999,
                   510000};
    for ( int i : value ){
        fout << i << " ,";
    }
    ...
    for( int i:value) {
        ...
        for (int j = 0; j<i;++j) {
            set_value(&arr, j, j, resize_plus_1);
    ...
    fout << "\n";
    fout << "plt.savefig('graphics/task2.1.pdf')";
    fout << "\n";
    fout << "plt.show()";
    return 0;
}